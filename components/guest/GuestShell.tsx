...
import { getGuestPageMeta } from "@/components/guest/guestNavigation";
              ...
              <div className="surface-card mb-4 rounded-[24px] px-4 py-3.5 sm:px-5">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center justify-center rounded-[16px] border border-border bg-white px-3.5 py-2.5 text-[13px] font-semibold text-text-secondary shadow-soft">
                      {badge}
                    </span>
          ...
          <div className="flex h-full flex-col">
            <div className="mb-3 flex justify-end">
              <button
                ...
                aria-label="Close guest navigation"
              >
                <svg
            ...
            <GuestSidebar onNavigate={() => setIsSidebarOpen(false)} />
          </div>
        </div>
      </div>
    </div>
