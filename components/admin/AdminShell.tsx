...
import { getAdminPageMeta } from "@/components/admin/adminNavigation";
...
export const AdminShell: React.FC<AdminShellProps> = ({
  ...
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-[14px] font-semibold text-text-primary">
                        {user ? `${user.firstName} ${user.lastName}` : "Admin account"}
                      </p>
                      <p className="truncate text-[12px] text-text-secondary">
                        {user?.email ?? "Signed in to the admin workspace"}
                      </p>
                    </div>
                  </div>
      ...
      <div className={`lg:hidden ${isSidebarOpen ? "pointer-events-auto" : "pointer-events-none"}`}>
        <div
        ...
        >
          <div className="flex h-full flex-col">
            ...
            <div className="min-h-0 flex-1 overflow-hidden rounded-[28px] border border-border-light bg-[linear-gradient(180deg,rgba(255,252,247,0.96)_0%,rgba(240,238,231,0.88)_100%)] shadow-[0_30px_90px_rgba(26,27,18,0.18)]">
