...
export const HostPropertySubmitPanel: React.FC<HostPropertySubmitPanelProps> = ({
  ...
  const description =
    status === "submitted"
      ...
      : status === "approved"
        ? "The listing has already cleared review and is live. If you made changes, submit again so the admin team can review them — doing so moves the listing back to Submitted and hides it from public search until it is approved again."
        : status === "rejected"
