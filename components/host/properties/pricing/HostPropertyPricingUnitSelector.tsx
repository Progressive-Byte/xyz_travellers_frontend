...
type HostPropertyPricingUnitSelectorProps = {
  units: HostPropertyUnit[];
  selectedUnitId: string;
  onSelect: (unitId: string) => void;
};

export const HostPropertyPricingUnitSelector: React.FC<HostPropertyPricingUnitSelectorProps> = ({
  units,
  selectedUnitId,
  onSelect,
}) => {
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[13px] text-text-secondary">
                    Capacity {unit.capacity || "not set"} • Beds {unit.beds || "not set"}
                  </p>
                </div>
